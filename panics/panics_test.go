...
func ExampleCatcher_callers() {
	...
	// Output:
	// github.com/khulnasoft/congo/panics.(*Catcher).tryRecover
	// runtime.gopanic
	// github.com/khulnasoft/congo/panics_test.ExampleCatcher_callers.func1
	// github.com/khulnasoft/congo/panics.(*Catcher).Try
	// github.com/khulnasoft/congo/panics_test.ExampleCatcher_callers
	// testing.runExample
	// testing.runExamples
	// testing.(*M).Run
	// main.main
